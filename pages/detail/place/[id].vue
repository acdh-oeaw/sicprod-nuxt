...
const endpoint = $api.apis_api_ontology_place_retrieve;
...
<template>
	...
	<DetailPage v-else model="Place" :details-loading="isLoading">
		<template #head>
		...
		<template #base>
			...
			<div class="col-span-2 my-2 border-t"></div>
			<span>{{ t("Pages.searchviews.place.alternative_names") }}:</span>
